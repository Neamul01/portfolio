...
const Projects = () => {
    return (
        <section class="bg-white dark:bg-gray-900  text-white">
            <div class="container w-full px-6 py-10 mx-auto overflow-hidden">
                ...
                <div class=" w-full grid grid-flow-row grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 md:mt-24 md:gap-8">
                    <div class="card bg-base-100 shadow-xl scroll-smooth overflow-y-scroll max-h-[300px] max-w-[300px] relative">
                        <div className="text-success bg-white absolute w-5/6 h-5/6 custom-style">Visit</div>
